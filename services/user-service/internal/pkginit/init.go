// Package pkginit wires shared pkg/ packages into the user-service.
...
// Services holds initialized shared package instances for the user-service.
...
// Init initializes all shared packages for the user-service.
func Init(cfg Config) (*Services, error) {
	...
	downstreamServices := []string{"auction-service", "bid-service", "payment-service", "notification-service"}
