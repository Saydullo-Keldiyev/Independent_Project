// Package pkginit wires shared pkg/ packages into the auction-service.
...
// Services holds initialized shared package instances for the auction-service.
...
// Init initializes all shared packages for the auction-service.
func Init(cfg Config) (*Services, error) {
	...
	downstreamServices := []string{"bid-service", "user-service", "payment-service", "notification-service"}
